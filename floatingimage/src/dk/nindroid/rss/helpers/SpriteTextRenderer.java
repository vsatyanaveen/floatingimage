package dk.nindroid.rss.helpers;
...
import dk.nindroid.rss.BitmapDownloader;
...
public class SpriteTextRenderer implements GLSurfaceView.Renderer{
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        if (mLabels != null) {
            ...
            mLabels = new LabelMaker(true, 512, 64);
        }
        mLabels.initialize(gl);
        mLabels.beginAdding(gl);
        mLabelA = mLabels.add(gl, "Allan", mLabelPaint);
        mLabelB = mLabels.add(gl, "Bertha", mLabelPaint);
        mLabelC = mLabels.add(gl, "Claus", mLabelPaint);
